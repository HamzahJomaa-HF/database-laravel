...
Schema::table('users_diploma', function (Blueprint $table) {
    ...
    $table->foreign('diploma_id', 'FK_USERS_DIPLOMA_DIPLOMA_ID')
          ->references('diploma_id')->on('diploma')
          ->onDelete('cascade');
});

Schema::table('users_nationality', function (Blueprint $table) {
    $table->foreign('user_id', 'FK_USERS_NATIONALITY_USER_ID')
          ->references('user_id')->on('users')
          ->onDelete('cascade');

    $table->foreign('nationality_id', 'FK_USERS_NATIONALITY_NATIONALITY_ID')
...
Schema::table('users_nationality', function (Blueprint $table) {
    $table->dropForeign('FK_USERS_NATIONALITY_USER_ID');
    $table->dropForeign('FK_USERS_NATIONALITY_NATIONALITY_ID');
});
