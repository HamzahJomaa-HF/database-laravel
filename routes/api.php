...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::get('/jwt/me', [JWTAuthController::class, 'me']);
    Route::get('/jwt/validate', [JWTAuthController::class, 'validateToken']);
    
    // Your existing User API routes - NOW PROTECTED WITH JWT
