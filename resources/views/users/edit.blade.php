        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 pt-3">
                <div>
                    ...
                    <p class="text-muted mb-0">Update professional contact in the system</p>
                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="status_1" id="status_1" class="form-control form-select @error('status_1') is-invalid @enderror" required>
                                            ...
                                            <option value="Active" {{ old('status_1', $user->status_1) == 'Active' ? 'selected' : '' }}>Active</option>
                                            <option value="Inactive" {{ old('status_1', $user->status_1) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status_1')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="status_2" id="status_2" class="form-control form-select @error('status_2') is-invalid @enderror">
                                            <option value="">Select Status</option>
                                            <option value="Active" {{ old('status_2', $user->status_2) == 'Active' ? 'selected' : '' }}>Active</option>
                                            <option value="Inactive" {{ old('status_2', $user->status_2) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status_2')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
        ...
        if (dobInput) {
            dobInput.addEventListener('change', function(e) {
                ...
                if (selectedDate > minAgeDate) {
                    ...
                    e.target.value = '{{ old("dob", $user->dob ? $user->dob->format("Y-m-d") : "") }}';
                }
            });
        }
