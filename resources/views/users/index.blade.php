...
<div class="alert alert-info d-flex justify-content-between align-items-center">
    <div>
        ...
        @if(request('name'))
            <span class="badge bg-primary me-1">Name: {{ request('name') }}</span>
        @endif
        @if(request('gender'))
            <span class="badge bg-primary me-1">Gender: {{ request('gender') }}</span>
        @endif
        @if(request('marital_status'))
            <span class="badge bg-primary me-1">Marital: {{ request('marital_status') }}</span>
        @endif
        @if(request('phone_number'))
            <span class="badge bg-primary me-1">Phone: {{ request('phone_number') }}</span>
        @endif
    </div>
