...
@section('title', 'Projects Management - Add Project')
...
<div class="dashboard-content">
    <div class="form-container">
        ...
        <div class="d-flex flex-row w-100 justify-content-between mb-4">
            <div>
                ...
                <p class="page-subtitle">Create a new project with the details below</p>
            </div>
        </div>
    ...
    @endforeach
                                    ...
                                    <div id="programInfo" class="program-info" style="display: none;">
                                        Type: <span id="programType"></span> | 
                                        Category: <span id="programCategory"></span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <select name="parent_project_id" id="parent_project_id" class="form-control select2">
                                        ...
                                        @foreach($parentProjects as $parent)
                                            <option value="{{ $parent->project_id }}" 
                                                    {{ old('parent_project_id') == $parent->project_id ? 'selected' : '' }}>
                                                {{ $parent->name }}
...
<div id="globalLoading" style="display: none;">
    <div style="text-align: center;">
        ...
        <p class="mt-3">Creating Project...</p>
    </div>
</div>
@endsection
