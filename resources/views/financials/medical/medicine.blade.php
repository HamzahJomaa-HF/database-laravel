...
@section('styles')
    ...
    <style>
        ...
        .bg-medicine  { background-color: #3b82f6 !important; color: white; }
...
<div class="dashboard-content">
    ...
    <div class="main-div">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="page-title">Medicine Financial Records</h4>
            <div class="action-buttons">
                ...
                <a href="{{ route('financials.medical.hospital') }}" class="btn btn-outline-danger">
        ...
        <div class="table-container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $financial->activity_financial_id }}"
                            ...
                            <td>
                                <span class="badge bg-medicine">Medical - Medicine</span>
                            </td>
                            <td>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p class="text-muted">No medicine financial records available</p>
                </div>
            @endif
        </div>
    </div>
...
<script>
    ...
    function renderViewMode() {
        ...
        for (const [key, value] of Object.entries(currentFinancialData)) {
            if (value !== null && value !== '' && value !== undefined) {
                const isHighlight = key === 'disease_type' || key === 'medication_type';
                html += `
    ...
    function saveEditMode() {
        ...
        // Preserve medication_type = 'medicine'
        updatedFinancialData.medication_type = 'medicine';
        ...
        .catch(() => showToast('error', 'Failed to update medicine record'));
    }
