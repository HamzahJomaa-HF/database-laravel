    ...
    <div class="mb-3" style="border: 1px solid #ddd; max-height: 400px; overflow-y: auto; background: white; position: absolute; z-index: 1000; width: 90%; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        @foreach($userResults as $user)
            <div class="p-3 border-bottom" style="cursor: pointer; transition: all 0.2s;" 
                ...
                {{-- Header with Full Name and Type Badge --}}
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>DOB:</strong> {{ $user['dob'] ?? 'Not set' }}
                        </small>
                    </div>
                    ...
                    <div>
                        <small class="text-muted">
                            <i class="fas fa-passport fa-fw"></i> 
                            <strong>Passport:</strong> {{ $user['passport_number']  }}
                        </small>
                    </div>
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>ID:</strong> {{ $user['identification_id'] }}
                        </small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-2">
                        @if($selectedUserDisplay['email'])
                            <small class="d-block text-muted">
                                <i class="fas fa-envelope"></i> {{ $selectedUserDisplay['email'] }}
                            </small>
                        @endif
                        
                        @if($selectedUserDisplay['phone_number'])
                            <small class="d-block text-muted">
                                <i class="fas fa-phone"></i> {{ $selectedUserDisplay['phone_number'] }}
                            </small>
                        @endif
                        
                        @if($selectedUserDisplay['dob'])
                            <small class="d-block text-muted">
                                <i class="fas fa-birthday-cake"></i> {{ $selectedUserDisplay['dob'] }}
                            </small>
                        @endif
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>Type:</strong> {{ $activity['type'] ?? 'Not specified' }}
                        </small>
                    </div>
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>Start Date:</strong> {{ $activity['start_date_formatted'] ?? 'No date' }}
                        </small>
                    </div>
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>Venue:</strong> {{ $activity['venue'] ?? 'No venue' }}
                        </small>
                    </div>
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            <strong>Max Capacity:</strong> {{ $activity['maximum_capacity'] ?? 'Not set' }}
                        </small>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        @if($selectedActivityDisplay['start_date_formatted'])
                            <small class="d-block text-muted">
                                <i class="fas fa-calendar"></i> Start: {{ $selectedActivityDisplay['start_date_formatted'] }}
                            </small>
                        @endif
                        ...
                        @if($selectedActivityDisplay['venue'])
                            <small class="d-block text-muted">
                                <i class="fas fa-map-marker-alt"></i> Venue: {{ $selectedActivityDisplay['venue'] }}
                            </small>
                        @endif
                        
                        @if($selectedActivityDisplay['maximum_capacity'])
                            <small class="d-block text-muted">
                                <i class="fas fa-users"></i> Max Capacity: {{ $selectedActivityDisplay['maximum_capacity'] }}
                            </small>
                        @endif
                    </div>
                </div>
